...
// AddBuildDevbiceByName - POST /build/:build_id_or_name/device/:device_id_or_serial_number
func (c *Client) AddBuildDeviceByName(name, device string) error {
	_, e := c.Build(name).Device(device).Post("").Send()
	return e
}

// AddBuildDevbiceByID - POST /build/:build_id_or_name/device/:device_id_or_serial_number
...
// DELETE /build/:build_id_or_name/rack/:rack_id_or_name
