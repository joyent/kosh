...
type Build struct {
	Admins                []UserTerse                   `json:"admins"`
	Completed             interface{}                   `json:"completed"`
	CompletedUser         interface{}                   `json:"completed_user"`
...
type BuildOrgganizations interface{}
...
type DetailedDevice struct {
	...
	SystemUUID        interface{}             `json:"system_uuid"`
	Updated           time.Time               `json:"updated"`
	UptimeSince       interface{}             `json:"uptime_since"`
...
type HardwareProduct struct {
	Alias          MojoStandardPlaceholder `json:"alias"`
	Created        time.Time               `json:"created"`
	GenerationName interface{}             `json:"generation_name"`
	ID             UUID                    `json:"id"`
	Name           MojoStandardPlaceholder `json:"name"`
	Sku            MojoStandardPlaceholder `json:"sku"`
	Updated        time.Time               `json:"updated"`
...
type Relay struct {
	...
	SSHPort      interface{}       `json:"ssh_port,omitempty"`
...
type WorkspaceAndRole struct {
	...
	ID                 UUID                    `json:"id"`
	Name               MojoStandardPlaceholder `json:"name"`
	ParentWorkspaceID  interface{}             `json:"parent_workspace_id"`
	Role               Role                    `json:"role"`
	RoleViaWorkspaceID UUID                    `json:"role_via_workspace_id,omitempty"`
}
...
type UserToken struct {
	...
	LastIpaddr interface{} `json:"last_ipaddr"`
